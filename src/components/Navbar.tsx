  ...
  return (
    <nav className="bg-indigo-600 p-4">
      ...
      <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <span className="text-xl font-semibold text-white">Cine Apolo</span>
      </div>

        <div>
          <Link to="/" className="text-white px-4 py-2 hover:bg-indigo-700 rounded-lg font-semibold">Home</Link>
          <Link to="/logout" className="text-white px-4 py-2 hover:bg-indigo-700 rounded-lg font-semibold">Logout</Link>
        </div>
      </div>
    </nav>
  );
